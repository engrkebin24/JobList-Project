...
// Sample Job Data - Planned to move to its separate file
const jobs = [
  {
    job_id: "01",
  ...
  },
  {
    ...
    notes: [
      "Checked dam foundation. All logs secure, no leaks detected.",
  ...
  },
  {
    ...
    notes: [
      "Delivered fresh timber for lodge expansion, awaiting client approval.",
...
export default function JobsPage() {
  //Note: Planned to move sorting and filtering functions into their separate utility file but ran out of time
  ...
  const getFilteredAndSortedJobs = () => {
    ...
    if (filterStatus) {
      filteredJobs = filteredJobs.filter(
        (job) => job.job_status === filterStatus
      );
    }
  ...
  return (
    <div>
      ...
      <div className={styles.sortAndFilterButtons}>
        <div className={styles.jobSortButtons}>
          ...
          <button
            ...
            className={styles.jobIDSortButton}
          >
          ...
          <button
            ...
            className={styles.jobDateSortButton}
          >
        ...
        <div className={styles.jobFilterButtonContainer}>
          ...
          <select
            ...
            className={styles.jobFilterButton}
          >
      ...
      <div className={styles.jobListAndDetailsContainer}>
        ...
        {/* Blank space would have been for a Map plugin and/or also a possible footer */}
      </div>
    </div>
  );
}
